...
<template>
  ...
  <div class="bg-gray-200 w-96 h-auto rounded-lg pt-8 pb-8 px-8 flex flex-col items-center">
      <label class="font-light text-4xl mb-4"><span class="font-bold">Grahslagg</span></label>

      <!-- <input type="text" class="w-full h-12 rounded-lg px-4 text-lg focus:ring-blue-600 mb-4" placeholder="Username"/>
